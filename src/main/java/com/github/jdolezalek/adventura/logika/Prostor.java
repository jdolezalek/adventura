...
public class Prostor {
	...
	private Map<String, Postavy> postavy;
    ...
    public String dlouhyPopis() {
     ...
     /**
     * Zamiká/odemiká místnost
     * 
     * @param zamkne/odemkne místnost - true/false
     */
	public void zamknout(boolean zamcena){
	 ...
	 /**
     * Vrací true pokud je místnost nepřístupná
     * 
     * @return přístupnost místnosti
     */
     ...
     */
	public void vlozPostavu(Postavy postava) {
        postavy.put(postava.getJmeno(), postava);
    }

    /**
     * Vrací instanci odebrané postavy (na základě názvu)
     *
     * @return instance odebrané postavy
     */
    public Postavy odeberPostavu(String nazev) {
        return postavy.remove(nazev);
    }

    /**
     * Vrací instance odebrané věci (na základě názvu)
     *
